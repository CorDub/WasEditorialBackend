...
import { deleteBook } from "../../../routes/admin/books/deleteBook.js";
...
describe("deleting a book with valid parameters", async() => {
  ...
  // We do not delete sales or kindlesales that have happened anymore even if we delete the inventory.
  // These need to be kept track of no matter what. 
