...
import { validateAuthorReturn } from "../routes/impressionHelpers.js";
import {
  createCategory,
  createAuthor,
  createBook,
...
describe(`validateAuthorReturn - less returns than delivered`, async() => {
  ...
  it(`should return true`, async() => {
    const res = await validateAuthorReturn(prisma, book.id, bookstore.id, 4)
...
//     const res = await validateAuthorReturn(prisma, book.id, bookstore.id, 10)
