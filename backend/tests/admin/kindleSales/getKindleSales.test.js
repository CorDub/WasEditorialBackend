...
import { getKindleSales } from "../../../routes/admin/kindleSales/getKindleSales.js";
import {
  createCategory,
  createAuthor,
  createBook,
...
describe("getting all valid kindle sales", async() => {
  ...
  beforeAll(async() => {
    ...
    newKindleSale2 = await createKindleSale(prisma, newBook.id, [newPayment.id, newPayment2.id], {quantityEbook: 10, quantityPod: 10, datePayStr: "2025-01-02", regalias: 100})
    newKindleSale3 = await createKindleSale(prisma, newBook.id, [newPayment.id, newPayment2.id], {quantityEbook: 10, quantityPod: 10, datePayStr: "2025-01-02", regalias: 100})
