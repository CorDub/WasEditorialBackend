...
import { updateAuthor } from "../../../routes/admin/authors/updateAuthor.js";
...
describe("updating an author with valid parameters", () => {
  ...
  it("should update the author in the database correctly", async() => {
    ...
    expect(updatedAuthor.phonePrefix).toBe("+44");
    expect(updatedAuthor.phone).toBe("5561356227");
    expect(updatedAuthor.birthday).toBe("22121989");
  })
})
