...
import { updateImpression } from "../../routes/adminRoutes.js";
import {
  createCategory,
  createAuthor,
  createBook,
...
describe(`updating an impression with invalid parameters`, async() => {
  ...
  beforeAll(async() => {
    newImpression2 = await createImpression(prisma, newBook2.id, {quantity: 1000, note: "this is a note", date: new Date('2025-11-04')})
