...
function AddingBookErrorList({ errorList, setErrorList }) {
  function displayError(error) {
    switch (error) {
      ...
      case 31:
        return (<p className="login-error">El precio debe estar un número.</p>)
      case 32:
      ...
      case 61:
        return (<p className="login-error">La cantidad debe ser un número.</p>)
      case 62:
        return (<p className="login-error">La cantidad debe estar superior a cero.</p>)
      case 71:
        return (<p className="login-error">La categoría debe estar un número</p>)
      default:
