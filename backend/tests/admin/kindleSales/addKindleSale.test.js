...
import { addKindleSale } from "../../../routes/admin/kindleSales/addKindleSale.js";
import {
  createCategory,
  createAuthor,
  createBook,
...
describe("adding valid kindle sale", async() => {
  ...
  beforeAll(async() => {
    ...
    mockReq = {
      "body": {
        ...
        "quantityEbook": 10,
        "quantityPod": 10,
        "dateCutStr": "2025-09-04",
        "datePayStr": "2025-11-04",
        "regalias": 121.5
      },
      prisma: prisma
    }
  ...
  it(`should create the kindle sale in the database`, async() => {
    ...
    expect(addedKindleSales[0].dateCutStr).toBe("2025-09-04")
    expect(addedKindleSales[0].datePayStr).toBe("2025-11-04")
  ...
  beforeAll(async() => {
    ...
    mockReq = {
      "body": {
        "quantityEbook": 10,
        "quantityPod": 10,
        "dateCutStr": "2025-08-13T00:00:00.000Z",
        "datePayStr": "2025-10-13T00:00:00.000Z",
        "regalias": 121.5
      },
      prisma: prisma
    }
