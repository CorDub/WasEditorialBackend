...
describe("updating an inventory with invalid parameters", async() => {
  ...
  beforeAll(async() => {
    ...
    newBookstore4 = await createBookstore(prisma);
    deletedBookstore = await createBookstore(prisma, {isDeleted: true});
    deletedInventory = await createInventory(prisma, newBook2.id, newBookstore.id, {initial: 1000, current: 1000, isDeleted: true, price: 499.99});
    newInventory = await createInventory(prisma, newBook.id, newBookstore.id, {initial: 3000, current: 3000, price: 499.99});
    newInventory2 = await createInventory(prisma, newBook.id, newBookstore2.id, {initial: 3000, current: 3000, returns: 10, givenToAuthor: 10, price: 499.99});
    newInventory3 = await createInventory(prisma, newBook.id, newBookstore3.id, {initial: 3000, current: 3000, returns: 10, givenToAuthor: 10, price: 499.99});
    newInventory4 = await createInventory(prisma, newBook.id, newBookstore4.id, {initial: 3000, current: 3000, returns: 0, givenToAuthor: 0, isDeleted: true, price: 499.99});
    newInventory5 = await createInventory(prisma, newBook3.id, newBookstore.id, {initial: 3000, current: 3000, returns: 10, givenToAuthor: 10, price: 499.99});
    newInventory6 = await createInventory(prisma, newBook4.id, newBookstore.id, {initial: 3000, current: 3000, returns: 10, givenToAuthor: 10, price: 499.99});
    newInventory7 = await createInventory(prisma, newBook5.id, newBookstore.id, {initial: 3000, current: 3000, isDeleted: true, returns:0, givenToAuthor: 0, price: 499.99});
    newPayment = await createPayment(prisma, newAuthor.id, getForMonth(new Date()));
    deletedSale = await createSale(prisma, newInventory.id, [newPayment.id], {quantity: 100, isDeleted: true});
    newSale1 = await createSale(prisma, newInventory.id, [newPayment.id], {quantity: 100});
    newSale2 = await createSale(prisma, newInventory.id, [newPayment.id], {quantity: 100});
...
describe("updating a deleted inventory", async() => {
  ...
  beforeAll(async() => {
    ...
    deletedBookstore = await createBookstore(prisma, {isDeleted: true});
    deletedInventory = await createInventory(prisma, newBook2.id, newBookstore.id, {initial: 1000, current: 1000, isDeleted: true, price: 499.99});
    newInventory = await createInventory(prisma, newBook.id, newBookstore.id, {initial: 1000, current: 1000, price: 499.99});
    newInventory2 = await createInventory(prisma, newBook.id, newBookstore2.id, {initial: 3000, current: 3000, returns: 10, givenToAuthor: 10, price: 499.99});
    newInventory3 = await createInventory(prisma, newBook.id, newBookstore3.id, {initial: 3000, current: 3000, returns: 10, givenToAuthor: 10, price: 499.99});
    newInventory4 = await createInventory(prisma, newBook.id, newBookstore4.id, {initial: 3000, current: 3000, returns: 0, givenToAuthor: 0, isDeleted: true, price: 499.99});
    newInventory5 = await createInventory(prisma, newBook3.id, newBookstore.id, {initial: 3000, current: 3000, returns: 10, givenToAuthor: 10, price: 499.99});
